...
`);
  ...
  {
    // Custom fork: was v126 on custom/main; renumbered to avoid colliding with
    // upstream v126–v132. Idempotent UPDATE — safe if already applied under the old number.
    version: 133,
