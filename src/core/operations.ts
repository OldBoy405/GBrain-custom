...
import { inboxOperations } from './ops/inbox.ts';
import { truthOperations } from './ops/truth.ts';
...
export const operations: Operation[] = [
  ...
  ...pagesOperations,
  // Custom fork: Inbox workflow (list_inbox, get_inbox_item,
  // trigger_inbox_enrichment, discard_inbox_items) — ops/inbox.ts
  ...inboxOperations,
  ...
  find_contradictions,
  // Custom fork: Compiled Truth workbench — ops/truth.ts
  ...truthOperations,
...
const OP_AREAS: Record<string, string> = {
  ...
  list_inbox: 'pages', get_inbox_item: 'pages',
  trigger_inbox_enrichment: 'pages', discard_inbox_items: 'pages',
  ...
  find_conflicts: 'insights', compile_truth: 'insights', adopt_compiled_truth: 'insights',
  // code intelligence
